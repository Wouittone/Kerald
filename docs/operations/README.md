...
See `container-images.md` for production image expectations,
`github-merge-gates.md` for repository merge protection and CI requirements,
and `multi-agent-development-flow.md` for the specialist-agent workflow used to
develop and review Kerald changes.
